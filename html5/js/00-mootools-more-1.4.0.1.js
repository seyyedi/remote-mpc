...
// Load this file's selection again by visiting: http://mootools.net/more/fed2cf20c587c2d128936727a8ed461b 
// Or build this file again with packager using: packager build More/Number.Format More/Element.Event.Pseudos.Keys More/Keyboard
/*
---
copyrights:
...
}a.decimals=b!=null?b:(a.decimals==null?2:a.decimals);return this.format(a);}});(function(){Events.Pseudos=function(h,e,f){var d="_monitorEvents:";var c=function(i){return{store:i.store?function(j,k){i.store(d+j,k);
